...
const handleImagesChange = (imagesData) => {
  console.log('🖼️ Images changées:', imagesData);
  reportImages.value = imagesData;
};
...
const submitReport = async () => {
  ...
  try {
    const reportData = {
      ...
      // Ajouter les images Cloudinary
      imageUrl: reportImages.value.imageUrl,
      images: reportImages.value.images
    };
...
const resetForm = () => {
  ...
  // Réinitialiser les images Cloudinary
  reportImages.value = {
    imageUrl: null,
    images: []
  };
